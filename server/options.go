...
type Options struct {
	...
	Credential          string `hcl:"credential" flagName:"credential" flagSName:"c" flagDescribe:"Credential for Basic Authentication (ex: user:pass;user2:pass2, default disabled)" default:""`
